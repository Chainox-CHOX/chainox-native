 ...
 * @param[out]  dbp     The already known disk position of pblock, or NULL ichoxt yet stored.
 ...
 * - "rpc": get critical warnings, which should put the client in safe mode ichoxn-empty
 ...
 * Fills hashRet with found hash, ichox nBlockHeight is specified - chainActive.Height() is used.
 */
