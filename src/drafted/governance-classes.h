 ...
 *
 *   // network
 *   CChainoxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CChainoxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CChainoxNetwork(UniValue objIn)
    {
...
// // can be under: ChainoxNetwork
// //   -- signature requirements : Key1(User)
// class CChainoxNetworkVariable : public CGovernanceObject
// {
// private:
