...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ChainoxNetwork") type = ChainoxNetwork;
    if(strType == "ChainoxNetworkVariable") type = ChainoxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ChainoxNetwork) s = "ChainoxNetwork";
    if(type == ChainoxNetworkVariable) s = "ChainoxNetworkVariable";
