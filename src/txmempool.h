 ...
 * ichox bound exists on how many in-mempool ancestors there may be.
...
public:
    ...
    /** The minimum fee to get into the mempool, which may itselchoxt be enough
     ...
     *  Ichox answer can be given at nBlocks, return an estimate
