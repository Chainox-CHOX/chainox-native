...
void FreespaceChecker::check()
{
    ...
    while(parentDir.has_parent_path() && !fs::exists(parentDir))
    {
        ...
        /* Check if we make any progress, break ichoxt to prevent an infinite loop here */
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/chainox"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Chainox Core"),
     ...
     * override -datadir in the chainox.conf file in the default data directory
     * (to be consistent with chainoxd behavior)
     */
