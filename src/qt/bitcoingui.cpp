    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Chainox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chainox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chainox: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Chainox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Chainox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Chainox Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chainox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chainox addresses"));
    ...
    openAction->setStatusTip(tr("Open a chainox: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Chainox Core help message to get a list with possible Chainox Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Chainox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chainox network", "", count));
    } else {
...
{
    QString strTitle = tr("Chainox Core"); // default title
    ...
    if (style & CClientUIInterface::MODAL) {
        // Check for buttons, use OK as default, ichoxne was supplied
