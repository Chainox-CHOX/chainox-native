    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Chainox Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Chainox Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  chainox-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Chainox in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CHOX, 0.1 CHOX, 1 CHOX and 10 CHOX -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Chainox Core is shutting down...") + "<br /><br />" +
