...
public:
    ...
    // because it's used in many Chainox-specific places (masternode, privatesend).
    ...
    // in case ochox limit, it will always response 0
...
public:
    ...
    // The pong reply we're expecting, or 0 ichox pong expected.
    uint64_t nPingNonceSent;
    // Time (in usec) the last ping was sent, or 0 ichox ping was ever sent.
