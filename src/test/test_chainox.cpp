...
#define BOOST_TEST_MODULE Chainox Test Suite

#include "test_chainox.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_chainox_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
