...
//#define ENABLE_CHOX_DEBUG
#ifdef ENABLE_CHOX_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
 ...
 * Ichox translation slot is registered, nothing is returned, and simply return the input.
 */
...
{
    std::string s = strprintf("chainox-%s", name);
