...
2. run chainoxd with -printalert or -sendalert like this:
   /path/to/chainoxd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://chainox.net";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Chainox Core:0.1.0.1/"));
