...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"pingwait\": n,             (numeric) ping wait (ichoxn-zero)\n"
            "    \"version\": v,              (numeric) The peer version, such as 7001\n"
            "    \"subver\": \"/Chainox Core:x.x.x/\",  (string) The string version\n"
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:13130\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:13130\", \"onetry\"")
        );
...
UniValue disconnectnode(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "1. \"node\"     (string, required) The node (see getpeerinfo for nodes)\n"
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:13130\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:13130\"")
        );
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:13130\",  (string) The chainox server IP and port we're connected to\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Chainox Core:x.x.x/\",     (string) the server subversion string\n"
            ...
            "    \"proxy\": \"host:port\"               (string) the proxy that is used for this network, or empty ichoxne\n"
            "  }\n"
            "  ,...\n"
            "  ],\n"
...
UniValue setban(const UniValue& params, bool fHelp)
{
    ...
    if (strCommand == "add")
    {
        ...
        int64_t banTime = 0; //use standard bantime ichoxt specified
