...
public:
    /*
     * Main wallet lock.
     * This lock chainoxs all the fields added by CWallet
     *   except for:
    ...
    void LoadKeyPool(int nIndex, const CKeyPool &keypool)
    {
        ...
        // Ichox metadata exists yet, create a default with the pool key's
    ...
    /// Get 1000 CHOX output and keys which can be used for the Masternode
