...
{
    const char* pszTimestamp = "Tue Feb 01 2022 00:00:00 GMT+0000 (1643673600) Successful launch of the main network of the ChainOX network.";
    const CScript genesisOutputScript = CScript() << ParseHex("046389ab0a8ca02cd657c7fa36797905ef8b5b951cade3084da754bb26e797933470cabcbc879092be5d7847f6583d75025753619836935echox80266bchox2eb1f7") << OP_CHECKSIG;
...
public:
	...
	consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000033c37c42f98b4f798");
        //consensus.nMinimumChainWork = uint256S("0x00");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000000e903a27de1c41c46e1c4c51f4e0598f25f6f7abbff596863220c17");
	...
	genesis = CreateGenesisBlock(1643673600, 15819430, 0x1e0fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x00000a575b43a2bdda937d37606e89e6804ded0ee8b16a9453affb15c8592e9c"));
        assert(genesis.hashMerkleRoot == uint256S("682b38e8609b0f3917f28276cb05f911e7848b8382ba80091ab62ef8c274db97"));

	vSeeds.push_back(CDNSSeedData("185.234.247.188", "185.234.247.188"));
	vSeeds.push_back(CDNSSeedData("146.19.233.119", "146.19.233.119"));
        ...
        // Chainox BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xF1)(0xE3)(0xA1)(0xD2).convert_to_container<std::vector<unsigned char> >();
        // Chainox BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xF3)(0xD1)(0x21)(0xA3).convert_to_container<std::vector<unsigned char> >();

        // Chainox BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (3900, uint256S("0x00000000cd941fcf587738950690e71a4d04e93ba127e5b03b2d837a11ffa605"))
            (23300, uint256S("0x0000000007f54e7e6294540ba97076543a224a3cd46b9b953c22a6f43456b865"))
            (42174, uint256S("0x0000000000e903a27de1c41c46e1c4c51f4e0598f25f6f7abbff596863220c17")),
            1647897713, // * UNIX timestamp of last checkpoint block
            66304,    // * total number of transactions between genesis and last checkpoint
...
public:
	...
	consensus.nMasternodePaymentsIncreasePeriod = 262537200; 
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 240; // 24 * 60 * 60; // Chainox: 1 day
        consensus.nPowTargetSpacing = 120; // 2.5 * 60; // Chainox: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        ...
        // Testnet Chainox BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Chainox BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Chainox BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        // Regtest Chainox BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Chainox BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Chainox BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
