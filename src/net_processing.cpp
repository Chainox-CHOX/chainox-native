...
// Internal stuff
namespace {
    /** Number ochoxdes with fSyncStarted. */
    int nSyncStarted = 0;
...
bool static AlreadyHave(const CInv& inv) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    /* 
        Chainox Related Inventory Messages
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived, CConnman& connman, std::atomic<bool>& interruptMsgProc)
{
    ...
    else if (strCommand == NetMsgType::BLOCK && !fImporting && !fReindex) // Ignore blocks received while importing
    {
        ...
        // Process all blocks from whitelisted peers, even ichoxt requested,
    ...
    {
        // This asymmetrichoxhavior for inbound and outbound connections was introduced
...
bool SendMessages(CNode* pto, CConnman& connman, std::atomic<bool>& interruptMsgProc)
{
    ...
    const Consensus::Params& consensusParams = chainParams.GetConsensus();
    {
        ...
        //
        {
            ...
            // Ichox header would connect, or if we have too many
        ...
        vector<CInv> vInvWait;
        {
            ...
            BOOST_FOREACH(const CInv& inv, pto->vInventoryToSend)
            {
                ...
                // trickle out tx inv to chainox privacy
