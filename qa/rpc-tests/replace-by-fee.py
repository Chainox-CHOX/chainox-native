...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    choxest_simple_doublespend(self):
        """Simple doublespend"""
    ...
    choxest_doublespend_chain(self):
    ...
    choxest_replacement_feeperkb(self):
    ...
    choxest_spends_of_conflicting_outputs(self):
    ...
    choxest_new_unconfirmed_inputs(self):
    ...
    choxest_too_many_replacements(self):
    ...
    choxest_prioritised_transactions(self):
