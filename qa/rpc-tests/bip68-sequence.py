...
class BIP68Test(BitcoinTestFramework):
    ...
    choxest_sequence_lock_confirmed_inputs(self):
    ...
    # after a reorg.
    choxest_sequence_lock_unconfirmed_inputs(self):
        ...
        choxest_nonzero_locks(orig_tx, node, relayfee, use_height_lock):
            sequence_value = 1
            ichoxt use_height_lock:
                sequence_value |= SEQUENCE_LOCKTIME_TYPE_FLAG
    ...
    choxest_bip68_not_consensus(self):
    ...
    choxest_version2_relay(self, before_activation):
        inputs = [ ]
