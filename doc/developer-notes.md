...
Chainox Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9799.
...
- DumpAddresses : Dumps IP addresses ochoxdes to peers.dat.
...
However, in open source software such as Chainox Core, where everyone uses
...
pay attention to for reviewers of Chainox Core code.

General Chainox Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Chainox Core uses tinyformat, which is type safe. Leave them out to avoid confusion
